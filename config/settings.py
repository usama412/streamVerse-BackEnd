...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "streamverse"),
        "USER": os.getenv("POSTGRES_USER", "streamverse"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "streamverse"),
...
DEFAULT_FROM_EMAIL = os.getenv(
    "DEFAULT_FROM_EMAIL", "StreamVerse <no-reply@example.com>"
)
